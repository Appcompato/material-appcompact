...
public class Main_IO_Units {
    ...
    public static String app_FaceBook_BannerAd_Size = "";
    public static String app_Google_BannerAd_Size = "";
    ...
    public static String App_Extra_Screen_1 = "";
    public static String App_Extra_Screen_2 = "";
    public static String App_Extra_Screen_3 = "";
    ...
    public void configDatas(JSONObject jsonObject) throws JSONException {
        ...
        app_FaceBook_BannerAd_Size = jsonObject.getString("app_FaceBook_BannerAd_Size");
        app_Google_BannerAd_Size = jsonObject.getString("app_Google_BannerAd_Size");
        ...
        App_Extra_Screen_1 = jsonObject.getString("App_Extra_Screen_1");
        App_Extra_Screen_2 = jsonObject.getString("App_Extra_Screen_2");
        App_Extra_Screen_3 = jsonObject.getString("App_Extra_Screen_3");
    ...
    public void showFacebookBanner() {
        ...
        if (app_FaceBook_BannerAd_Size.equalsIgnoreCase("BANNER_50")) {
            fbadView = new com.facebook.ads.AdView(activity, FB_Banner_ID1, com.facebook.ads.AdSize.BANNER_HEIGHT_50);
        } else if (app_FaceBook_BannerAd_Size.equalsIgnoreCase("BANNER_90")) {
            fbadView = new com.facebook.ads.AdView(activity, FB_Banner_ID1, com.facebook.ads.AdSize.BANNER_HEIGHT_90);
        } else if (app_FaceBook_BannerAd_Size.equalsIgnoreCase("RECTANGLE_HEIGHT_250")) {
            fbadView = new com.facebook.ads.AdView(activity, FB_Banner_ID1, com.facebook.ads.AdSize.RECTANGLE_HEIGHT_250);
        } else {
            fbadView = new com.facebook.ads.AdView(activity, FB_Banner_ID1, com.facebook.ads.AdSize.BANNER_HEIGHT_50);
        }
    ...
    public void showFacebookBanner2() {
        ...
        if (app_FaceBook_BannerAd_Size.equalsIgnoreCase("BANNER_50")) {
            ...
            fbadView = new com.facebook.ads.AdView(activity, FB_Banner_ID2, com.facebook.ads.AdSize.BANNER_HEIGHT_90);
        } else if (app_FaceBook_BannerAd_Size.equalsIgnoreCase("RECTANGLE_HEIGHT_250")) {
            fbadView = new com.facebook.ads.AdView(activity, FB_Banner_ID2, com.facebook.ads.AdSize.RECTANGLE_HEIGHT_250);
        } else {
            fbadView = new com.facebook.ads.AdView(activity, FB_Banner_ID2, com.facebook.ads.AdSize.BANNER_HEIGHT_50);
        }
    ...
    public void showFacebookBanner3() {
        ...
        if (app_FaceBook_BannerAd_Size.equalsIgnoreCase("BANNER_50")) {
            ...
            fbadView = new com.facebook.ads.AdView(activity, FB_Banner_ID3, com.facebook.ads.AdSize.BANNER_HEIGHT_90);
        } else if (app_FaceBook_BannerAd_Size.equalsIgnoreCase("RECTANGLE_HEIGHT_250")) {
            fbadView = new com.facebook.ads.AdView(activity, FB_Banner_ID3, com.facebook.ads.AdSize.RECTANGLE_HEIGHT_250);
        } else {
            fbadView = new com.facebook.ads.AdView(activity, FB_Banner_ID3, com.facebook.ads.AdSize.BANNER_HEIGHT_50);
        }
    ...
    public void showAdmobBanner() {
        ...
        if(app_Google_BannerAd_Size.equalsIgnoreCase("BANNER")){
            mAdView.setAdSize(AdSize.BANNER);
        }else if(app_Google_BannerAd_Size.equalsIgnoreCase("LARGE_BANNER")){
            mAdView.setAdSize(AdSize.LARGE_BANNER);
        }else if(app_Google_BannerAd_Size.equalsIgnoreCase("MEDIUM_RECTANGLE")){
            mAdView.setAdSize(AdSize.MEDIUM_RECTANGLE);
        }else if(app_Google_BannerAd_Size.equalsIgnoreCase("FULL_BANNER")){
            mAdView.setAdSize(AdSize.FULL_BANNER);
        }else if(app_Google_BannerAd_Size.equalsIgnoreCase("LEADERBOARD")){
            mAdView.setAdSize(AdSize.LEADERBOARD);
        }else if(app_Google_BannerAd_Size.equalsIgnoreCase("SMART_BANNER")){
